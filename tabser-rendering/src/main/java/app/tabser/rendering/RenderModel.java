...
import app.tabser.rendering.blocks.LineBlock;
import app.tabser.rendering.blocks.PageBlock;
import app.tabser.rendering.blocks.RenderBlock;
import app.tabser.rendering.blocks.SongHeaderBlock;
...
//        public int calculatedBeatCount;
        ...
        public Rectangle getDocumentDimensions() {
            Rectangle lastBounds=sheetModel.documentBlocks.get(sheetModel.documentBlocks.size() - 1).getBounds();
            return new Rectangle(0,0,lastBounds.right,lastBounds.bottom);
        }
