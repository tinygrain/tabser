...
public final class RenderOptions {
    ...
    public static class SheetFormat {
        ...
        private SheetFormat(Element... format) {
            this.format = Arrays.copyOf(format, format.length);
        }
    }
    ...
    private RenderOptions(Rectangle viewPort, SheetMetrics sheetMetrics,
    ...
    public static final class Builder {
        ...
        public Builder setViewPort(Rectangle viewPort) {
            this.viewPort = viewPort;
            return this;
        }
